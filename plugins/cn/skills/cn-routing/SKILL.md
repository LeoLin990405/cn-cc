...
| 2 | 超长文本, >200K tokens, 跨代码库分析, 多文档综合 | **mimo** | 1M context (Xiaomi flagship) |
| 3 | 长文本, 50K–200K, 论文, 合同, 文档综述 | **kimi** | 128K context window |
| 4 | 数学, 证明, 逻辑推理, 方程, 优化, 算法推导 | **stepfun** | Math/logic specialist |
| 5 | 深度推理, 中文理解, 语义分析, 知识问答 | **glm** | Strong Chinese reasoning |
| 6 | 快速回答, 简单任务, 低延迟, 轻量 | **minimax** | Fastest response time |
| 7 | 通用中文编码, 代码生成, 默认 | **doubao** | Best all-round Chinese coder |
